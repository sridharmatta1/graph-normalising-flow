...
# ============================================================
# Same as run_molecular_autoencoder_v3.sh (matta's account),
# pointed at bidaralli's paths -- see that script's comments for
# why these changes (higher bond_class_weight + longer training)
...
srun $PYTHON -u molecular_generation/train_molecular_autoencoder.py \
    ...
    --wandb_run_name "molecular_autoencoder_v3_qm9_bidaralli"
