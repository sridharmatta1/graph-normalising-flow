#!/bin/bash
#SBATCH --job-name=GNF_ego
#SBATCH --output=logs/ego_output_%a.log
#SBATCH --error=logs/ego_error_%a.log
...
RESULTS_DIR=$WORKDIR/results/ego/seed_$SEED

# ============================================================
# HYPERPARAMETERS  (ego-small paper settings)
# ============================================================
...
srun $PYTHON $WORKDIR/run_gnn.py \
    ...
    --wandb_run_name "ego_seed${SEED}_gnn"
...
srun $PYTHON $WORKDIR/train_grevnet_with_data.py \
    ...
    --max_checkpoints_to_keep 5 \
    --wandb_project $WANDB_PROJECT \
    --wandb_run_name "ego_seed${SEED}_grevnet"
...
srun $PYTHON $WORKDIR/generate_graphs.py \
    ...
    --wandb_project $WANDB_PROJECT \
    --wandb_run_name "ego_seed${SEED}_generate"
...
srun $PYTHON $WORKDIR/compute_mmd.py \
    ...
    --wandb_project $WANDB_PROJECT \
    --wandb_run_name "ego_seed${SEED}_mmd"
