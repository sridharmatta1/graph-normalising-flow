...
#
# NConditionedGNFBlock now has the same per-step batch-norm
# renormalization as GNFBlock (--use_batch_norm, on by default),
# so full-scale settings should no longer overflow to NaN/Inf.
# ============================================================
